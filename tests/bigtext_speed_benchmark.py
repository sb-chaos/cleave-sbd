...
sbd_segmenter = pragmatic_sbd.Segmenter(language="en", clean=False, char_span=False)
...
def pragmatic_sbd_tokenize(text):
    segments = sbd_segmenter.segment(text)
